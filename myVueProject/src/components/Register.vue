<template>
    <CreatePatientForm :createPatient="true"/>
...
<script>
import CreatePatientForm from './admin/CreatePatientForm.vue'
export default {
    name: 'Register',
    components: {
        CreatePatientForm
...
//             };
//            axios.post('/auth/signUpPatient', data)
//            .then(
//             res => {
...
//                     console.log(err.response.data.bindingResult); //.response.data.bindingResult
